...
/**
 * @brief When the getter, setter, deleter, call, etc. behavior occurs on the object, the corresponding
...
typedef struct {
    ...
    /** A callback function triggered by deletting a named property of an instance object. */
    ...
    /** A callback function triggered by deletting an indexed property of an instance object. */
 ...
 * corresponding callback when getter, setter, deleter, call, and other behaviors occur on the object.
 *
 * @since 12
 */
