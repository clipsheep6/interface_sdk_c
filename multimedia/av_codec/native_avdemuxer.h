 ...
 * @version 1.0
 */
OH_AVErrCode OH_AVDemuxer_SetDrmInfoCallback(OH_AVDemuxer *demuxer, OH_DRM_DrmInfoCallback callback);
 ...
 * @version 1.0
 */
OH_AVErrCode OH_AVDemuxer_GetDrmInfo(OH_AVDemuxer *demuxer, OH_DRM_DrmInfo **drmInfo);
