...
/**
 * @brief Capture session smooth zoom info callback to be called in {@link CaptureSession_Callbacks}.
 *
 * @param session the {@link Camera_CaptureSession} which deliver the callback.
...
typedef struct CaptureSession_Callbacks {
    ...
    /**
     * Capture session smooth zoom info event.
     * @since 12
     */
    OH_CaptureSession_OnSmoothZoomInfo onSmoothZoomInfo;
