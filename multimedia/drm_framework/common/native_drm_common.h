...
/**
 * @brief MediaKeySystemInfo used for player to get DRM info from media source.
 * @since 11
 * @version 1.0
 */
...
/**
 * @brief Media key system info call back.
 * @param mediaKeySystemInfo Media key system info gotten from multimedia source.
 * @return void.
 * @since 11
 * @version 1.0
 */
