...
Drm_ErrCode OH_MediaKeySession_ProcessMediaKeyResponse(MediaKeySession *mediaKeySession,
    unsigned char *response, int32_t responseLen, unsigned char *offlineMediaKeyId, int32_t *offlineMediaKeyIdLen);
...
Drm_ErrCode OH_MediaKeySession_GenerateOfflineReleaseRequest(MediaKeySession *mediaKeySessoin,
    unsigned char *offlineMediaKeyId, int32_t offlineMediaKeyIdLen, unsigned char *releaseRequest,
...
Drm_ErrCode OH_MediaKeySession_ProcessOfflineReleaseResponse(MediaKeySession *mediaKeySessoin,
    unsigned char *offlineMediaKeyId, int32_t offlineMediaKeyIdLen, unsigned char *releaseReponse,
