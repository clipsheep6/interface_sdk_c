...
typedef enum {
    ...
    IMAGE_UNSUPPORTED_MIMETYPE = 7600101,                    // unsupported mime type
    IMAGE_UNKNOWN_MIMETYPE = 7600102,                        // unknown mime type
    ...
    IMAGE_UPSUPPORTED_CONVERSION = 7600203,                  // unsupported conversion
