 ...
 * @return 0 - Indicates successful;<br>
 *         12300001 - Indicates the internal error.<br>
 *         12300002 - Indicates the <i>buf</i> is NULL pointer or the size of the name, including the terminating
 *         character ('\0'), is larger then <i>buf_size</i>;
 * @syscap SystemCapability.Account.OsAccount
 * @since 12
 */
