 ...
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param OH_Drawing_Run Indicates the pointer to an <b>OH_Drawing_Run</b> object.
 * @param start The run of start position.
 * @param end The run of end position.
 * @return Run of glyphs array.
 * @since 13
 * @version 1.0
 */
 ...
 *
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param glyphs The run of glyphs array.
 * @param index The run of glyphs index.
...
/**
 * @brief Releases the memory run glyphs array.
 * 
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param glyphs The run of glyphs array.
 * @since 13
 ...
 *
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
 * @param OH_Drawing_Array The run of positions array.
 * @param index The run of glyph index.
...
/**
 * @brief Releases the memory run of positions array.
 * 
 * @syscap SystemCapability.Graphic.Graphic2D.NativeDrawing
