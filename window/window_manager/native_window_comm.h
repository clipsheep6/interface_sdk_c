...
/**
 * @brief Enumerates the action types of the key event
 *
 * @since 12
 */
typedef enum {
    ...
    /** the key was lift down. */
    OH_KEY_ACTION_UP = 1,
} OH_WMKeyAction;

/**
 * @brief Enumerates the key code of the key event
 *
 * @since 12
 */
typedef enum {
...
/**
 * @brief Structure  of the key event
 *
 * @since 12
 */
typedef struct {
