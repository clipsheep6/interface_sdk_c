...
/**
 * @brief Adds information about a caller that can invoke this TA.
 * This API applies to the client applications (CAs) in the native CA and APK format.
 *
...
/**
 * @brief Adds information about a caller that can invoke this TA.
 * This API applies to the client applications (CAs) in the APK format.
 *
 * @param ca_name Indicates the process name of the caller of the CA.
...
/**
 * @brief Defines the caller is CA from REE side.
 *
 * @since 12
 */
...
/**
 * @brief Defines the caller is TA from REE side.
 *
 * @since 12
 */
