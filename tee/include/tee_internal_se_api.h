 ...
 * @return Returns {@code TEE_SUCCESS} if the operation is successful.
 *         Returns {@code TEE_ERROR_BAD_PARAMETERS} if input parameter is incorrect.
 *         Returns {@code TEE_ERROR_BAD_FORMAT} if cannot find the input SE service handle.
 ...
 *         Returns {@code TEE_ERROR_SHORT_BUFFER} if the session is opened.
 *
 * @since 12
 * @version 1.0
 */
 ...
 *
 * @return Returns {@code TEE_SUCCESS} if the operation is successful.
 *         Returns {@code TEE_ITEM_NOT_FOUND} if the session is closed.
 *         Returns {@code TEE_ERROR_BAD_PARAMETERS} if input parameter is incorrect.
 *         Returns {@code TEE_ITEM_NOT_FOUND} if cannot find the input SE reader handle.
 ...
 * It can be used for insecure communication, but the APDU that calls {@code TEE_SEChannelTransmit} transmission is not secure. 
 *
 * @param se_channel_handle  Indicates the SE channel handle.
 *
 * @since 12
