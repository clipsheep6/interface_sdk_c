 ...
 * @since 11
 */
typedef void (*Rdb_SyncCallback)(void *context, Rdb_ProgressDetails *progressDetails);
 ...
 * @param callback The {@link Rdb_SyncCallback} for the automatic synchornizaiton progress
 ...
 *
 * @param store Indicates the pointer to the target {@Link OH_Rdb_Store} instance.
 * @param callback Indicates the {@link Rdb_SyncCallback} callback for the automatic synchornizaiton progress.
