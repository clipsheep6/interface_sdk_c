 ...
 * @since 12
 */
Crypto_Result OH_CryptoVerify_Create(const char *algoName, OH_CryptoVerify **verify);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoVerify_Init(OH_CryptoVerify *ctx, OH_CryptoPubKey *pubKey);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoVerify_Update(OH_CryptoVerify *ctx, Crypto_DataBlob *in);

/**
 * @brief Used to verify message, include the update data.
 *
 * @param ctx Indicates the verify context.
 * @param in Indicates the data need to be verified.
 ...
 * @since 12
 */
Crypto_Result OH_CryptoVerify_Recover(OH_CryptoVerify *ctx, Crypto_DataBlob *signData, Crypto_DataBlob *rawSignData);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoVerify_SetParam(OH_CryptoVerify *ctx, CryptoSignature_ParamType type, Crypto_DataBlob *value);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoVerify_GetParam(OH_CryptoVerify *ctx, CryptoSignature_ParamType type, Crypto_DataBlob *value);
