...
/**
 * @brief Define asymmetric key parameter types.
 *
 * @since 12
 */
typedef enum {
...
typedef enum {
    ...
    /** DER format */
    CRYPTO_DER = 1,
} Crypto_Encoding_type;

/**
 * @brief Define asymmetric key generator structure.
 * 
 * @since 12
 */
 ...
 *         {@link OH_Crypto_ErrCode#CRYPTO_ERR_CRYPTO_OPERTION} 17630001 - If crypto opertion failed.
 * @since 12
 */
Crypto_Result OH_CryptoAsymKeyGenerator_Create(const char *algoName, OH_CryptoAsymKeyGenerator **ctx);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoAsymKeyGenerator_Generate(OH_CryptoAsymKeyGenerator *ctx, OH_CryptoKeyPair **keyCtx);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoAsymKeyGenerator_Convert(OH_CryptoAsymKeyGenerator *ctx, Crypto_Encoding_type type,
 ...
 * @since 12
 */
Crypto_Result OH_CryptoPubKey_Encode(OH_CryptoPubKey *key, Crypto_Encoding_type type,
 ...
 * @since 12
 */
Crypto_Result OH_CryptoPubKey_GetParam(OH_CryptoPubKey *key, CryptoAsymKey_ParamType item, Crypto_DataBlob *value);
