 ...
 *         {@link OH_Crypto_ErrCode#CRYPTO_NOT_SUPPORT} 801 - If the operation is not supported.
 *         {@link OH_Crypto_ErrCode#CRYPTO_ERR_MALLOC} 17620001 - If malloc failed.
 *         {@link OH_Crypto_ErrCode#CRYPTO_CRYPTO_OPERTION} 17630001 - If crypto opertion failed.
 * @since 12
 */
Crypto_Result OH_CryptoSymCipherParams_Create(OH_CryptoSymCipherParams **params);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoSymCipherParams_SetParam(OH_CryptoSymCipherParams *params,
...
/**
 * @brief Create a symmetric key cipher context according to the given algorithm name. Example AES128|GCM|PKCS7.
 *
 ...
 * @since 12
 */
Crypto_Result OH_CryptoSymCipher_Create(const char *algoName, OH_CryptoSymCipher **ctx);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoSymCipher_Init(OH_CryptoSymCipher *ctx, Crypto_CipherMode mod,
 ...
 * @since 12
 */
Crypto_Result OH_CryptoSymCipher_Update(OH_CryptoSymCipher *ctx, Crypto_DataBlob *in, Crypto_DataBlob *out);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoSymCipher_Final(OH_CryptoSymCipher *ctx, Crypto_DataBlob *in, Crypto_DataBlob *out);
