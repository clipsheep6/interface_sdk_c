...
typedef enum {
    ...
    CRYPTO_ERR_MALLOC = 17620001,
    /** Indicates that crypto operation error. */
    CRYPTO_ERR_CRYPTO_OPERTION = 17630001,
} Crypto_Result;
 ...
 */
typedef enum {
    /** The value of encryption operation. */
    CRYPTO_ENCRYPT_MODE = 0,
    /** The value of decryption operation. */
 ...
 *
 * @param dataBlob Indicates the crypto data.
 * @since 12
 */
