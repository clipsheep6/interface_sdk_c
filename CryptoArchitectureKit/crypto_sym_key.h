 ...
 * @since 12
 */
Crypto_Result OH_CryptoSymKeyGenerator_Create(const char *algoName, OH_CryptoSymKeyGenerator **ctx);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoSymKeyGenerator_Generate(OH_CryptoSymKeyGenerator *ctx, OH_CryptoSymKey **keyCtx);
 ...
 * @since 12
 */
Crypto_Result OH_CryptoSymKeyGenerator_Convert(OH_CryptoSymKeyGenerator *ctx,
 ...
 * @since 12
 */
Crypto_Result OH_CryptoSymKey_GetKeyData(OH_CryptoSymKey *keyCtx, Crypto_DataBlob *out);
