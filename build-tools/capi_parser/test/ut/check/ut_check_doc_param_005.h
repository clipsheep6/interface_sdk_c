...
extern "C" {
     ...
     *
     * @param keyEventb Indicates the pointer to this <b>OH_NativeXComponent_KeyEvent</b> instance.
     * @param deviceIda Indicates the deviceId of the <b>OH_NativeXComponent_KeyEvent</b> instance.
