...
extern "C" {
     ...
     *
     * @param keyEventa Indicates the pointer to this <b>OH_NativeXComponent_KeyEvent</b> instance.
     * @param deviceIdb Indicates the deviceId of the <b>OH_NativeXComponent_KeyEvent</b> instance.
