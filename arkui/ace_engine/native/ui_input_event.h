...
enum {
    ...
    UI_INPUT_EVENT_ACTION_CANCEL = 0,
    /** Pressing of a touch point. */
    UI_INPUT_EVENT_ACTION_DOWN = 1,
    /** Moving of a touch point. */
    UI_INPUT_EVENT_ACTION_MOVE = 2,
    /** Lifting of a touch point. */
    UI_INPUT_EVENT_ACTION_UP = 3,
};
...
enum {
    /** Unknown tool type. */
    UI_INPUT_EVENT_TOOL_TYPE_UNKNOWN = -1,

    /** Finger. */
    UI_INPUT_EVENT_TOOL_TYPE_FINGER = 0,

    /** Stylus. */
    UI_INPUT_EVENT_TOOL_TYPE_STYLUS = 1,
};
...
enum {
    /** Unknown source type. */
    UI_INPUT_EVENT_SOURCE_TYPE_UNKNOWN = -1,
    /** Touchscreen. */
    UI_INPUT_EVENTT_SOURCE_TYPE_TOUCH_SCREEN = 0,
    /** Stylus. */
    UI_INPUT_EVENT_SOURCE_TYPE_STYLUS = 1,
    /** Touchpad. */
    UI_INPUT_EVENT_SOURCE_TYPE_TOUCHPAD = 2,
};
