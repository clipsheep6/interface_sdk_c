...
/**
 * @brief Arrow enumerated value of the Swiper navigation point.
 *
 * @since 12
 */
typedef enum {
    /** Do not display the arrows of the navigation points in the swiper.*/
    ARKUI_SWIPER_ARROW_HIDE = 0,
    /** Displays the arrows of the navigation points in the swiper.*/
    ARKUI_SWIPER_ARROW_SHOW,
    /** Displays the arrowhead of the navigation point in the swiper in the hover state.*/
...
typedef enum {
    ...
    /** The animation is played in the forward direction for odd times (1, 3, 5...) and in the backward direction for even times (2, 4, 6...).*/
...
/**
 * @brief Defines the display mode when the text is too long.
 *
 * @since 12
 */
typedef enum {
    /** If the text is too long, the system does not crop the text.*/
    ARKUI_TEXT_OVERFLOW_NONE = 0,
    /** If the text length is too long, the system crops the text.*/
    ARKUI_TEXT_OVERFLOW_CLIP,
    /** If the text is too long, the text that cannot be displayed is replaced by an ellipsis.*/
    ARKUI_TEXT_OVERFLOW_ELLIPSIS,
    /** When the text is too long, the text is displayed as a racehorse lamp.*/
