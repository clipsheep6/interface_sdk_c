...
/**
 * @brief Define the configuration information for ListitemMainSizeAdapter.
 *
 * @since 12
 */
typedef struct ArkUI_ListItemMainSizeAdapter ArkUI_ListItemMainSizeAdapter;
...
/**
 * @brief Create a configuration item for the ListitemMainSizeAdapter interface settings.
 *
 * @param defaultChildrenSize The default size of the sub components in the spindle direction.
 * @return List Item MainSizeAdapter configuration item instance.
 * @since 12
 */
ArkUI_ListItemMainSizeAdapter* OH_ArkUI_ListItemMainSizeAdapter_Create(float defaultChildrenSize);

/**
* @brief Destroy the ListitemMainSizeAdapter instance.
*
* @param adapter List Item MainSizeAdapter instance to be destroyed.
* @since 12
*/
void OH_ArkUI_ListItemMainSizeAdapter_Dispose(ArkUI_ListItemMainSizeAdapter* adapter);

/**
 * @brief Modify the default size of subcomponents in the spindle direction.
 *
 * @param adapter List Item MainSizeAdapter configuration item instance.
 * @param defaultChildrenSize The size of the spindle direction.
 * @since 12
*/
void OH_ArkUI_ListItemMainSizeAdapter_SetDefaultSize(ArkUI_ListItemMainSizeAdapter* adapter, float defaultChildrenSize);

/**
 * @brief Obtain the default size of the sub components in the spindle direction.
 *
 * @param adapter List Item MainSizeAdapter configuration item instance.
 * @return The default size of the sub components in the spindle direction. Return value on exception: 0.
 * @since 12
*/
float OH_ArkUI_ListItemMainSizeAdapter_GetDefaultSize(ArkUI_ListItemMainSizeAdapter* adapter);

/**
 * @brief Batch adding, deleting, and modifying the size information of sub components in the spindle direction.
 *
 * @param adapter List Item MainSizeAdapter configuration item instance.
 * @param getMainSize Callback interface.
 *        Index array position.
*         return The height of the item at the corresponding position.
 * @since 12
*/
void OH_ArkUI_ListItemMainSizeAdapter_RegisterGetMainSizeCallback(ArkUI_ListItemMainSizeAdapter* adapter, float (*getMainSize)(int32_t index));
...
* @since 12
*/
void OH_ArkUI_ListItemSwipeActionItem_Dispose(ArkUI_ListItemSwipeActionItem* option);
...
* @since 12
*/
void OH_ArkUI_ListItemSwipeActionItem_SetContent(ArkUI_ListItemSwipeActionItem* option, ArkUI_NodeHandle builder);
...
* @since 12
*/
void OH_ArkUI_ListItemSwipeActionItem_SetActionAreaDistance(ArkUI_ListItemSwipeActionItem* option, float distance);
...
* @since 12
*/
float OH_ArkUI_ListItemSwipeActionItem_GetActionAreaDistance(ArkUI_ListItemSwipeActionItem* option);
...
* @since 12
*/
void OH_ArkUI_ListItemSwipeActionItem_SetOnEnterActionArea(ArkUI_ListItemSwipeActionItem* option, void (*callback)());
...
* @since 12
*/
void OH_ArkUI_ListItemSwipeActionItem_SetOnAction(ArkUI_ListItemSwipeActionItem* option, void (*callback)());
...
* @since 12
*/
void OH_ArkUI_ListItemSwipeActionItem_SetOnExitActionArea(ArkUI_ListItemSwipeActionItem* option, void (*callback)());
...
* @since 12
*/
void OH_ArkUI_ListItemSwipeActionItem_SetOnStateChange(ArkUI_ListItemSwipeActionItem* option, void (*callback)(ArkUI_ListItemSwipeActionState swipeActionState));
...
* @since 12
*/
void OH_ArkUI_ListItemSwipeActionOption_SetEdgeEffect(ArkUI_ListItemSwipeActionItem* option, ArkUI_ListItemSwipeEdgeEffect edgeEffect);
...
* @since 12
*/
int32_t OH_ArkUI_ListItemSwipeActionOption_GetEdgeEffect(ArkUI_ListItemSwipeActionItem* option);
...
* @since 12
*/
void OH_ArkUI_ListItemSwipeActionOption_SetOnOffsetChange(ArkUI_ListItemSwipeActionItem* option, void (*callback)(float offset));
#ifdef __cplusplus
};
#endif
